  ...
  for (const drawingPath of drawingPaths) {
    ...
    if (!isLand && /\/drawing2\.xml$/i.test(drawingPath)) {
      ...
      const fixedHouseObjects: Record<string, { x: number; y: number; width: number; height: number }> = {
        "35": { x: 4945403, y: 2810609, width: 3478714, height: 2606809 },
        "33": { x: 4958442, y: 6020789, width: 3480345, height: 2645112 },
        "22": { x: 4944588, y: 9221189, width: 3480345, height: 2645112 },
        "36": { x: 4936174, y: 2234609, width: 1335232, height: 540000 },
        "34": { x: 4936174, y: 5444789, width: 1335232, height: 540000 },
        "32": { x: 4922320, y: 8645189, width: 1335232, height: 540000 },
      };
      Array.from(drawingDocument.documentElement.children).forEach(anchor => {
