...
<div className="topbar-row"><div className="brand"><h1>總表　管理模式 <small className="app-version">V432</small></h1></div>
...
const intakeDraftEditorTitle = (draft: IntakeData) => {
  ...
  const area = city && city !== "台南市" && district
    ...
    : district || "未填地區";
  const shortAddress = (addressParts?.[3] || address).trim() || "未填地址";
