...
export default function Home() {
  ...
  const saveRecord = () => {
    ...
    const next = existing ? (_materialEditAt ? withTrackedUpdate(existing, prepared) : { ...prepared, updateDate: existing.updateDate, lastModifiedAt: existing.lastModifiedAt, _updateHistory: existing._updateHistory }) : prepared;
  ...
  return <main lang="en-GB" className={internalView ? "internal-public-app" : ""}>
    {!internalView && <header className="topbar">
      <div className="brand"><h1>總表　管理模式 <small className="app-version">V71</small></h1></div>
