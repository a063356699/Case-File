...
<div className="topbar-row"><div className="brand"><h1>總表　管理模式 <small className="app-version">V453</small></h1></div>
...
function ChecklistPageV2({ val }: { val: (...keys: string[]) => string }) {
  return <article className="print-page checklist-page">
    ...
    <div className="check-acquire"><b>12. 是否<span className="acquire-highlight">一年內</span>取得：</b>☐是　☐否，取得年份：______年　取得原因：☐買賣　☐法拍　☐繼承　☐贈與　其他：______</div>
