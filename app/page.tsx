...
<div className="topbar-row"><div className="brand"><h1>總表　管理模式 <small className="app-version">V390</small></h1></div>
...
function printRecordDocument(record: RecordItem, kind: "color" | "cover") {
  ...
  const coverV3 = `<div class="page intake-cover-v3"><style>
    ...
    <div class="document-wrap"><div class="vertical-label document-label"><span>內</span><span>附</span><span>文</span><span>件</span><span>之</span><span>正</span><span>本</span></div><div class="document-content">
      ...
      <div class="sub">●此物件為銷售都市土地需申請使用分區申請日期：<span class="form-box cover-date-box">${escapeHtml(record.zoningApplicationDate ? displayRocDate(record.zoningApplicationDate) : "")}</span></div>
      <div class="sub">●此物件為銷售土地需要且已附分區證明×<span class="form-box">${escapeHtml(record.zoningCertificateCount || "")}</span>張</div>
      <div class="sub">●此物件為銷售土地，謄本 已標示--不用附上使用分區</div>
