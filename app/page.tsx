...
export default function Home() {
  ...
  return <main lang="zh-Hant-TW" className={internalView ? `internal-public-app${publicAuthReady ? " public-auth-ready" : ""}` : ""}>
    {!internalView && <header className="topbar">
        <div className="topbar-row"><div className="brand"><h1>總表　管理模式 <small className="app-version">V475</small></h1></div>
...
async function printKeyLabel(record: RecordItem) {
  ...
  printDocument.open();
  printDocument.write(`<!doctype html><html lang="zh-Hant"><head><meta charset="UTF-8"><title>鑰匙標籤 ${escapeHtml(propertyNo)}</title><style>@page{size:105mm 50mm;margin:0}*{box-sizing:border-box}html,body{width:105mm;height:50mm;margin:0;padding:0;background:#fff!important;color:#000!important;font-family:"Microsoft JhengHei",sans-serif;-webkit-print-color-adjust:exact;print-color-adjust:exact}.print-sheet{width:105mm;height:50mm;display:flex;align-items:flex-start;background:#fff!important;color:#000!important}.label{width:75mm;height:50mm;border:.35mm solid #000;overflow:hidden;background:#fff!important;color:#000!important}.info{height:25mm;padding:.8mm 1.4mm .6mm;border-bottom:.3mm dashed #555;display:flex;flex-direction:column;justify-content:space-between;background:#fff!important;color:#000!important}.topline,.case-line,.metric-line{display:flex;align-items:center;gap:1.2mm;white-space:nowrap}.topline{font-size:10pt;font-weight:900}.topline b{font-size:11pt}.topline .key{margin-left:auto}.case-line{font-size:10.5pt;font-weight:900}.case-line .case{max-width:52mm;overflow:hidden;text-overflow:ellipsis}.case-line .developer{margin-left:auto;font-size:9pt}.address{font-size:9.5pt;font-weight:800;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.metric-line{font-size:8.5pt;font-weight:700}.company{font-size:8pt;font-weight:700;display:flex;justify-content:space-between;align-items:center;white-space:nowrap}.barcode-blank{height:25mm;background:#fff!important}.side-stack{width:30mm;height:50mm;background:#fff!important;color:#000!important}.side-card{width:30mm;height:25mm;border:.35mm solid #000;padding:1.2mm;display:flex;align-items:center;justify-content:center;text-align:center;font-weight:900;line-height:1.12;overflow:hidden;overflow-wrap:anywhere;background:#fff!important;color:#000!important}.side-case{font-size:10.5pt}.side-address{font-size:9.5pt}</style></head><body><main class="print-sheet"><section class="label"><div class="info"><div class="topline"><b>${escapeHtml(propertyNo)}</b><span class="key">公司#${escapeHtml(keyNumber)}</span></div><div class="case-line"><span class="case">${escapeHtml(record.caseName || "—")}</span><span class="developer">${escapeHtml(developerFullNameText(record.developer) || "—")}</span></div><div class="address">${escapeHtml(record.address || "—")}</div><div class="metric-line">${metrics}</div><div class="company"><span>台南文化崇明加盟店</span><span>電話：06-3356699</span></div></div><div class="barcode-blank"></div></section><aside class="side-stack"><div class="side-card side-case">${escapeHtml(record.caseName || "—")}</div><div class="side-card side-address">${escapeHtml(record.address || "—")}</div></aside></main></body></html>`);
  printDocument.close();
