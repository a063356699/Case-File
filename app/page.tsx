...
export default function Home() {
  ...
  return <main lang="zh-Hant-TW" className={internalView ? `internal-public-app${publicAuthReady ? " public-auth-ready" : ""}` : ""}>
    {!internalView && <header className="topbar">
        <div className="topbar-row"><div className="brand"><h1>總表　管理模式 <small className="app-version">V467</small></h1></div>
...
async function printKeyLabel(record: RecordItem) {
  ...
  let qrDataUrl = "";
  try { qrDataUrl = await QRCode.toDataURL(keyCode, { width: 280, margin: 1, errorCorrectionLevel: "M", color: { dark: "#000000", light: "#ffffff" } }); }
