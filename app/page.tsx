...
import { createColorWorkbookMap, placeColorWorkbookMap } from "./colorWorkbookMap";
...
export default function Home() {
  ...
  const loadPptAssetFolder = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    files.forEach(file => {
      ...
      if (/\.gif$/i.test(file.name)) pair.gif = file;
      else pair.layout = file;
